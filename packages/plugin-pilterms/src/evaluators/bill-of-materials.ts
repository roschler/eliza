// This module tracks the progress of the current context
//  dependent bill-of-materials list.
...
async function handler(
    ...
    // Request generateText from the current LLM to analyze conversation and suggest goal updates
